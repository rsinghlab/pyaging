...
def convert_adata_to_tensor_and_filter_features(
    ...
    """
    Convert an AnnData object's data matrix to a PyTorch tensor and filter features.
    ...
    other genomic elements) and converts this subset into a PyTorch tensor. This tensor can then be used for
    further analysis or model input in PyTorch-based workflows.
    ...
    features : list of str
        A list of feature names to be included in the tensor. Only these features from the AnnData object will
    ...
    -------
    tensor : torch.Tensor
        A PyTorch tensor containing the filtered data from the AnnData object, with dtype set to float32.
    ...
    >>> tensor = convert_adata_to_tensor_and_filter_features(adata, features, logger)
    >>> tensor.shape
    torch.Size([5, 3])
...
def add_pred_ages_adata(
    ...
    clock_name : str
        The name of the biological aging clock used to generate the predicted ages. This name will be used
    ...
    This function is part of a pipeline that integrates biological aging clock predictions with the
...
def add_clock_metadata_adata(
    ...
    This function enriches an AnnData object with metadata related to a specific biological aging clock.
    ...
    clock_name : str
        The name of the biological aging clock. The metadata associated with this clock will be added to
        the AnnData object.
    ...
    here ensures that all relevant information about the biological aging clocks used in the analysis is
